...
<div class="regiBox">
    ...
    <div class="outerInputBox">
        ...
        <form class="myForm" action="regiSeller.do" method="post" id="form">
            <div class="innerInputBoxSpecial">
                <div class="innerId">
                    <label for="id">아이디 : &nbsp;</label>
                </div>
                <div class="innerText">
                    <input type="text" class="inputs idInput" id="id" placeholder="아이디" name="id" required="required" style="width:200px;">
            ...
            <div class="innerInputBox">
                ...
                <div class="innerText">
                    <input type="password" class="inputs" id="password" placeholder="비밀번호" name="password"
                           size="15" maxlength="100" onkeyup="return passwordChanged()" required="required" style="width:200px;">
            ...
            <div class="innerInputBox">
                ...
                <div class="innerText">
                    <input type="password" class="inputs" id="confirmPwd" placeholder="비밀번호확인" name="confirmPwd"
                           size="15" maxlength="100" onkeyup="return passwordMatch()" required="required" style="width:200px;">
            ...
            <div class="innerInputBox">
                <div class="innerId">
                    <%--@declare id="store_name"--%><label for="store_name">스토어 이름 : &nbsp;</label>
                </div>
                <div class="innerText">
                    <input id="store_name"  type="text" class="inputs" name="store_name" required="required" placeholder="스토어이름" style="width:200px;">
                </div>
            </div>
