    ...
    <div class="outerInputBox">
        ...
        <form class="myForm" action="regiSeller.do" method="post" id="form">
            <div class="innerInputBoxSpecial">
                ...
                <div class="innerText">
                    <input type="text" class="inputs idInput" id="id" placeholder="아이디" name="id" required="required">
            ...
            <div class="innerInputBox">
                ...
                <div class="innerText">
                    <input id="store_name"  type="text" class="inputs" name="store_name" required="required">
                </div>
            </div>
